...
JOB_TITLES: Dict[str, List[str]] = {
    ...
    "artifact_hunter": [
        ...
        "Reliquary Raider",
        "Cursebreaker",
        "Black-Market Appraiser",
        "Forbidden Seeker",
        "Ancient Vaultmaster",
        "Royal Relic Broker",
        "Legendary Artifact Hunter",
        "Mythic Tomb Diver",
        "Crown of Ruins",
        "Relic Tycoon",
        "Eclipse Curator",
        "Vaultfall Survivor",
        "Forbidden Fortune Lord",
        "Abyss Reliquary King",
        "World Relic Sovereign",
    ],
    "drug_lord": [
        "Street Operator",
        "Corner Boss",
        ...
        "Mythic Kingpin",
        "Iron Territory Lord",
        "Cash Warehouse Tyrant",
        "Citywide Phantom",
        "Midnight Revenue King",
        "Eclipse Syndicate Boss",
        "Underworld Emperor",
        "Worldshadow Sovereign",
    ],
    "dragon_slayer": [
        "Novice Hunter",
        "Scale Tracker",
        ...
        "Wyvern Cutter",
        "Bounty Spear",
        "Heartscale Harvester",
        "Royal Huntmaster",
        "Ancient Wyrm Killer",
        "Legendary Dragon Slayer",
        "Mythic Beast Executioner",
        "Crownfire Reaper",
        "Stormwing Butcher",
        "Ashen Contract Lord",
        "Eclipse Fang Hero",
        "Kingdom's Final Lance",
        "Mythbreaker",
        "World Dragon Bane",
    ],
    "business_ceo": [
    ...
    "space_miner": [
        ...
        "Reactor Runner",
        "Starshaft Miner",
        "Alien Core Extractor",
        "Deep Sector Harvester",
        "Legendary Space Miner",
        "Mythic Void Driller",
        "Cosmic Loadmaster",
        "Starstorm Prospector",
        "Hullfire Survivor",
        "Eclipse Excavator",
        "Singularity Stripminer",
        "Galactic Ore Lord",
        "Cosmic Extraction Legend",
    ],
}
